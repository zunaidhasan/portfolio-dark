...
function ProjectCard({
  ...
  return (
    <motion.button
      ...
      className={`group relative block w-full text-left overflow-hidden rounded-2xl border bg-bg-card/60 p-6 backdrop-blur-sm transition-colors duration-300 sm:p-8 ${
        isFlagship
    ...
    >
      ...
      <div className="relative flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="hidden shrink-0 sm:block">
          <div className="grid h-11 w-11 place-items-center rounded-full border border-line text-ink-muted transition-all duration-300 group-hover:border-transparent group-hover:bg-accent group-hover:text-bg">
            <ArrowUpRight
              size={18}
